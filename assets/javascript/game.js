...
//This function is meant to return the page to the game state, but I can't seem to get it to work. 
function reset(){
  $(".gameContainer").empty();
  gameTimer();
  startGame();
...
//Reset button, generated by JS, doesn't seem to work. Madness.
